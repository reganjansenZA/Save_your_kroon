...
def main():
    print("Welcome to the Save Your Kroon App")
    initial_budget = float(input("Please enter your kroon for the month : "))
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("Are you dom, please choose correctly.")
